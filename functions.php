...
function adler_scripts() {
	...
	wp_enqueue_script( 'adler-rellax', get_template_directory_uri() . '/assets/js/jquery.rellax.js', array( 'jquery' ), '20120206', true );
	...
	wp_enqueue_script( 'adler-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20130115', true );
